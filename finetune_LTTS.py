...
# finetune gradtts trained on libritts
...
@hydra.main(version_base=None, config_path='./resources/pretrained/', config_name='ltts_config')
def main(cfg: DictConfig):
    ...
    model = GradTTS(cfg)
    model.load_state_dict(torch.load(cfg.model.checkpoint, map_location=lambda loc, storage: loc))
    model.to(device)
